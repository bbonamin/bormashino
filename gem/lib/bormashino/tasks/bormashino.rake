...
WASI_VFS_RELEASE = 'https://github.com/kateinoigakukun/wasi-vfs/releases/download/v0.1.1/wasi-vfs-cli-aarch64-apple-darwin.zip'.freeze
...
namespace :bormashino do
  ...
  task :download do
    ...
    system "curl -L -o wasi-vfs.zip '#{WASI_VFS_RELEASE}'"
